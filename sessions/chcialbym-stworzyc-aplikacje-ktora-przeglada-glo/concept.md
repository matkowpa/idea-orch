...
1. Zbuduj osobisty POC (nie produkt komercyjny) — RSS/API, 3-5 źródeł, prosty model sentymentu, bez LLM w pętli, bez scrapingu HTML.
2. Wykonaj backtest 6-12 miesięcy z jasnymi metrykami (hit rate, zwrot vs. benchmark, drawdown) i z góry ustalonym progiem "kill/continue".
3. Jeśli sentyment nie ma wartości predykcyjnej — pivot ostateczny na "filtr szumu + personalizacja" bez aspiracji predykcyjnych (to nadal może mieć wartość UX, ale inny model monetyzacji i inne oczekiwania).
4. Dopiero po pozytywnej walidacji rozważać komercjalizację, definicję personalizacji jako realnego wyróżnika i konsultację prawną dot. regulacji.
...
_2026-08-29 11:43 UTC_

| Model | Wywołania | Tokeny in | Tokeny out | Koszt (USD) |
|---|---|---|---|---|
| `openrouter/anthropic/claude-sonnet-5` | 4 | 28,941 | 6,053 | $0.1184 |
| `openrouter/openai/gpt-5-mini` | 2 | 5,037 | 2,846 | $0.0070 |
| `openrouter/openai/gpt-5.1` | 2 | 4,999 | 2,957 | $0.0358 |
| `openrouter/z-ai/glm-5.3` | 2 | 5,135 | 2,301 | $0.0154 |
