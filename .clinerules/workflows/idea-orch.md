...
4. Poinformuj użytkownika: wykonanie trwa kilka minut (10 wywołań LLM, ~$0.05–0.09 wg cennika OpenRouter z 2026-08-29; szczegóły: plan-idea-orch.md §7).
5. Uruchom orchestrator i poczekaj na zakończenie. Na końcu wypisuje koszt sesji i generuje `sessions\<slug>\cost_report.md` — wskaż ten koszt użytkownikowi.
...
> UWAGA: to workflow Cline (szablon w repo). Aby podpowiadanie `/idea-orch`
> działało w innym projekcie, skopiuj ten plik do
> `<projekt>\.clinerules\workflows\idea-orch.md`.
